// NodeMcu v1.0 Esp-8266 with 1.8" TFT LCD SPI Display

#include <Adafruit_GFX.h>    // Core graphics library
#include <Adafruit_ST7735.h> // Hardware-specific library
#include <SPI.h>

#define TFT_RST 16  //1-RST
#define TFT_CS 15   //2-CE
#define TFT_DC 2    //3-D/C
#define TFT_MOSI 13 //4-DIN
#define TFT_SCLK 14 //5-CLK
